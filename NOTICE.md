...
whose README requires a linking plugin to be GPL-3.0-or-later or GPL-compatible. The whole work, both build
lines and the source, is GPL-3.0-or-later from its first version.
